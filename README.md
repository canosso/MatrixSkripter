...
<p>Use any language char for text instead of only ![Ascii 0-128 chars](http://en.wikipedia.org/wiki/ASCII#ASCII_printable_characters), [I'm an inline-style link](https://www.google.com) i.e. the whole ![UTF-8 chars](http://en.wikipedia.org/wiki/UTF-8#Examples) could be used
<o:p></o:p></p>
